...
// !! useeffect istifade etdikde dependency array i olmalidi yoxa use effect hereseye tetiklenecek konfliktler yarada biler
// !! eger 1 defe run olsun isteyirikse []
// !! nedense asili olmasi ucun [asili oldugu state]
...
const mapStateToProps = (state) => ({
  info: state,
  // !! statein hamisini oturmek yuerine lazim olan hisseleri parcalayib uygun adda gondermek daha uygun
  // !! meselen info : state.info
});
